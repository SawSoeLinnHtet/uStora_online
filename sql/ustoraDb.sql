...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2163242942ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="281">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=users">`ustoraDb`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=orders">`ustoraDb`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=carts">`ustoraDb`.`carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=products">`ustoraDb`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=categories">`ustoraDb`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ustoraDb&table=admin">`ustoraDb`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_sales&table=orders">`car_sales`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_sales&table=staff">`car_sales`.`staff`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_sales&table=cars">`car_sales`.`cars`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_sales&table=car_types">`car_sales`.`car_types`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6d437e6a28475e456f474e47656c517d">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="281"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ustoraDb" targettable="users">
